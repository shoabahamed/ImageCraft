...
export const CircleProperties = ({
  ...
  // const handleFillToggle = (show: boolean) => {
  ...
  //       tab: "shape",
  //       event: "update",
  //       message: `Circle fill ${show ? "enabled" : "disabled"}`,
  //       param: "fill",
  //       objType: "circle",
  //     });

  //     selectedObject.set({
  //       fill: show ? circleFill : "transparent",
  //     });
  //     setCircleFill(show ? circleFill : "transparent");
  ...
  // const handleStrokeToggle = (show: boolean) => {
  //   const selectedObject = canvasRef.current.getActiveObject();
  //   if (selectedObject) {
  //     addLog({
  //       section: "shape",
  //       tab: "shape",
  //       event: "update",
  //       message: `Circle stroke ${show ? "enabled" : "disabled"}`,
  //       param: "stroke",
  //       objType: "circle",
  //     });

  //     selectedObject.set({
  //       stroke: show ? circleStroke : "transparent",
  //     });
  //     setCircleStroke(show ? circleStroke : "transparent");
  //     selectedObject.setCoords();
  //     canvasRef.current.fire("object:modified");
  //     canvasRef.current.renderAll();
  //   }
  ...
  const handleCircleFill = (value) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle fill color changed to ${value}`,
        param: "fill",
        objType: "circle",
      });
  ...
  const handleCircleStrokeWidth = (value) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle stroke width changed to ${value}`,
        param: "strokeWidth",
        objType: "circle",
      });
  ...
  const handleCircleSkewX = (value) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle skew X changed to ${value}`,
        param: "skewX",
        objType: "circle",
      });
  ...
  const handleCircleSkewY = (value) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle skew Y changed to ${value}`,
        param: "skewY",
        objType: "circle",
      });
  ...
  const handleShadowToggle = (checked: boolean) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle shadow ${checked ? "enabled" : "disabled"}`,
        param: "shadow",
        objType: "circle",
      });
  ...
  const handleShadowColor = (value: string) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle shadow color changed to ${value}`,
        param: "shadowColor",
        objType: "circle",
      });
  ...
  const handleShadowBlur = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle shadow blur changed to ${value}`,
        param: "shadowBlur",
        objType: "circle",
      });
  ...
  const handleShadowOffsetX = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle shadow offset X changed to ${value}`,
        param: "shadowOffsetX",
        objType: "circle",
      });
  ...
  const handleShadowOffsetY = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Circle shadow offset Y changed to ${value}`,
        param: "shadowOffsetY",
        objType: "circle",
      });
