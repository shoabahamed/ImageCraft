  ...
  const handleTriangleStrokeWidth = (value) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle stroke width changed to ${value}`,
        param: "strokeWidth",
        objType: "triangle",
      });
  ...
  const handleShadowToggle = (checked: boolean) => {
    ...
    if (selectedObject) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle shadow ${checked ? "enabled" : "disabled"}`,
        param: "shadow",
        objType: "triangle",
      });
  ...
  const handleShadowColor = (value: string) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle shadow color changed to ${value}`,
        param: "shadowColor",
        objType: "triangle",
      });
  ...
  const handleShadowBlur = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle shadow blur changed to ${value}`,
        param: "shadowBlur",
        objType: "triangle",
      });
  ...
  const handleShadowOffsetX = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle shadow offset X changed to ${value}`,
        param: "shadowOffsetX",
        objType: "triangle",
      });
  ...
  const handleShadowOffsetY = (value: number) => {
    ...
    if (selectedObject && selectedObject.shadow) {
      addLog({
        ...
        tab: "shape",
        event: "update",
        message: `Triangle shadow offset Y changed to ${value}`,
        param: "shadowOffsetY",
        objType: "triangle",
      });
