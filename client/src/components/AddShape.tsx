...
//     canvasRef.current.on("selection:updated", handleObjectSelected);
//     canvasRef.current.on("object:scaling", handleObjectScaled);
//     canvasRef.current.on("object:modified", handleObjectModified);
//     canvasRef.current.on("selection:cleared", handleObjectDeselected);

//     return () => {
//       canvasRef.current.off("selection:created", handleObjectSelected);
//       canvasRef.current.off("selection:updated", handleObjectSelected);
//       canvasRef.current.off("selection:cleared", handleObjectDeselected);
//       canvasRef.current.off("object:modified", handleObjectModified);
//       canvasRef.current.off("object:scaling", handleObjectScaled);
